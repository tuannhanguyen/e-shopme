...
public class UserPDFExporter {
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        table.setWidths(new float[] {1.5f, 4.5f, 2.5f, 3.5f, 3.0f, 4.5f});
        ...
        for (User user : listUsers) {
        	total += Float.parseFloat(user.getEstimated());
        }
        
        Paragraph sum = new Paragraph("Tong tien: " + total, font);
        sum.setAlignment(Paragraph.ALIGN_CENTER);
